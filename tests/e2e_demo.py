...
tenant = post(f"{BASE['saas']}/api/tenants", {
...
template = post(f"{BASE['marketplace']}/marketplace/templates", {
...
integration = post(f"{BASE['marketplace']}/marketplace/integrations", {
...
install = post(f"{BASE['marketplace']}/marketplace/integrations/install", {
    "tenant_id": tenant_id,
