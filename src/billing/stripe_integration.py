...
class StripeIntegration:
    ...
    def create_invoice_item(self, customer_id: str, amount: float, currency: str = "usd", description: str = "") -> Dict[str, Any]:
    ...
    def create_payment_intent(self, amount: float, currency: str = "usd", metadata: Optional[Dict] = None) -> Dict[str, Any]:
